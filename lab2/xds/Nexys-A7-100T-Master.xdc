...
create_clock -add -name sys_clk_pin -period 20.00 -waveform {0 10} [get_ports {clk100_i}];
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { key_i[1] }]; #IO_L4N_T0_D05_14 Sch=btnu
